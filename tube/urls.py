...
urlpatterns = [
    ...
    path("<int:post_id>/<int:user_id>/subscribe/", views.tube_subscribe, name="tube_subscribe"),
    path("<int:post_id>/<int:user_id>/unsubscribe/", views.tube_unsubscribe, name="tube_unsubscribe"),
]
